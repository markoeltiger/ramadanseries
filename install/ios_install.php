...
require_once '../includes/lb_helper_ios.php'; // Include LicenseBox external/client api helper file
            ...
            switch ($step) {
              default: ?>
                ...
                <div style='text-align: right;'>
                  ...
                  <?php }else{ ?>
                  <a href="ios_install.php?step=0" class="button is-link">Next</a>
                  <?php } ?>
                </div><?php
                break;
              case "0": ?>
                ...
                <?php
                  ...
                  if(!empty($_POST['license'])&&!empty($_POST['client'])){
                    ...
                    if($activate_response['status'] != true){ ?>
                      <form action="ios_install.php?step=0" method="POST">
                      ...
                      <form action="ios_install.php?step=1" method="POST">
                  ...
                  if($_POST && isset($_POST["lcscs"])){
                    ...
                    if(!empty($db_host)){
                      ...
                      $sqlUpdate="UPDATE tbl_settings SET 
                        ...
                        `envato_ios_purchase_code` = '".$_SESSION['envato_purchase_code']."',
                        `envato_ios_purchased_status` = '1' WHERE `id` = 1";
                    ...
                    ?>
                    <form action="ios_install.php?step=2" method="POST">
